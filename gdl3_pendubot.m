...
close all
clc
%% DEFINICIÓN SIMBÓLICA DE VARIABLES ARTICULARES Y PARÁMETROS GEOMÉTRICOS
...
%% MODELADO CINEMÁTICO MEDIANTE MATRICES HOMOGÉNEAS
%Junta 1 
...
%% OBTENCIÓN DE LA POSICIÓN DEL EFECTOR FINAL EN EL MARCO INERCIAL
% La posición final del efector se obtiene en PO(:,:,GDL)
...
%% CÁLCULO DEL JACOBIANO LINEAL MEDIANTE MÉTODO DIFERENCIAL
...
%% CÁLCULO DEL JACOBIANO LINEAL Y ANGULAR MEDIANTE MÉTODO ANALÍTICO
...
%% DETERMINACIÓN DE VELOCIDAD LINEAL Y ANGULAR DEL EFECTOR FINAL
